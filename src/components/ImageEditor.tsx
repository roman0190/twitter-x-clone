...
const ImageEditor = ({
  ...
  const handleClickSensitive = (sensitive: boolean) => {
    setSettings((prev) => ({ ...prev, sensitive: sensitive }));
  };
    ...
    <div className="fixed w-screen h-screen left-0 top-0 bg-black bg-opacity-75 z-10 flex items-center justify-center ">
      <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            className="py-2 px-4 rounded-full text-black bg-white font-bold"
            onClick={onClose}
          >
            Save
          </button>
        ...
        <div className="flex items-center justify-between text-sm md:gap-0 gap-10">
          ...
          <div
            className={`cursor-pointer py-1 px-4 rounded-full text-sm text-black font-bold ${
